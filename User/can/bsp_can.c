...
static void CAN_Filter_Config(void)
{
	...
	/*CAN筛选器初始化*/
	CAN_FilterInitStructure.CAN_FilterNumber=0;						//筛选器组0 F103有14组筛选器
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh= ((((u32)0x1314<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF0000)>>16;		//要筛选的ID高位 
											// 0001001100010100 << 3 | 0100| 0000 = 1001 1000 1010 0000 | 0100
											// 1001 1000 1010 0100 & FFFF0000
	CAN_FilterInitStructure.CAN_FilterIdLow= (((u32)0x1314<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF; //要筛选的ID低位 // 高位 0 低位 0x98A4
